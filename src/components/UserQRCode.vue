      ...
      <table>
        ...
        <tbody>
          <tr v-for="(booking, index) in bookings" :key="index" class="booking">
            ...
            <td>
              <button @click="cancelBooking(booking)">Cancel Booking</button> <!-- Cancel booking button -->
            </td>
          </tr>
        </tbody>
      </table>
...
h2 {
  ...
  color: #000000; /* Set text color to contrast with dark background */
}

.info {
  font-size: 15px;
  color: #333333; /* Set text color to contrast with white */
...
th {
  background-color: #333333; /* Set header background color */
